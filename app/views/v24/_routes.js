...
router.post('/v24/where-do-you-live', function (req, res) {

  const whereDoYouLive = req.session.data['where-do-you-live']

  if (whereDoYouLive == 'yes') {
    res.redirect('/v24/apply/date-of-birth');
  } else {
    res.redirect('/v24/apply/kickouts/not-eligible-country');
  }
...
router.post('/v24/date-of-birth', function (req, res) {
...
router.post('/v24/name', function (req, res) {
  ...
  router.post('/v24/address', function (req, res) {
  ...
  router.post('/v24/national-insurance-number', function (req, res) {

    var nationalinsurancenumber = req.session.data['nationalinsurancenumber'].toUpperCase().replace(/\s+/g, '');
  
    if (nationalinsurancenumber) {
      res.redirect('/v24/apply/check-your-answers-personal-details')
    } else {
      res.redirect('/v24/apply/national-insurance-number')
    }
  ...
  router.post('/v24/cya-personal-details', (req, res) => {
  ...
  req.session.data['dateofbirth'] = new Intl.DateTimeFormat('en-GB', {year: 'numeric', month: 'long', day: 'numeric'}).format(new Date(dateofbirth))
    ...
    if (nationalinsurancenumber) {
      ...
      if (firstname == 'CHARLIE' && lastname == 'SMITH' && nationalinsurancenumber == 'AB123456A' && dateofbirth == '01/01/2000' && postcode == 'LL673SN' && addressline1 == '55 PEACHFIELD ROAD') {
        ...
        res.redirect('/v24/apply/kickouts/confirmation-no-match')
  ...
  router.post('/v24/current-claim', function (req, res) {

    var currentclaim = req.session.data['currentclaim']

    if (currentclaim === "no") {
      res.redirect('/v24/apply/where-do-you-live')
    }
    else if (currentclaim === "yes") {
      res.redirect('/v24/apply/what-change')
    }
    else {
  ...
  router.post('/v24/what-change', function (req, res) {
    ...
    if (whatchange === "add-pregnancy") {
      ...
      res.redirect('/v24/apply/kickouts/call-us-to-update') 
    }   
...
router.post('/v24/date-of-birth-update', function (req, res) {
  ...
  if (dateofbirthday && dateofbirthmonth && dateofbirthyear) {
    if (yrs < 16) {
      ...
      res.redirect('/v24/apply/name-update');
    }
  } else {
    res.redirect('/v24/apply/date-of-birth-update')
  }
...
router.post('/v24/date-of-birth-update-2', function (req, res) {
  ...
  if (dateofbirthday && dateofbirthmonth && dateofbirthyear) {
    if (yrs < 16) {
      ...
      res.redirect('/v24/apply/name-update-2');
    }
  } else {
    res.redirect('/v24/apply/date-of-birth-update-2')
  }
...
router.post('/v24/name-update', function (req, res) {
  ...
  if (firstname && lastname) {
    res.redirect('/v24/apply/postcode-update')
  }
  else {
    res.redirect('/v24/apply/name-update')
  }
...
router.post('/v24/name-update-2', function (req, res) {
  ...
  if (firstname && lastname) {
    res.redirect('/v24/apply/postcode-update-2')
  }
  else {
    res.redirect('/v24/apply/name-update-2')
  }
...
router.post('/v24/name-update-4', function (req, res) {
 ...
 router.post('/v24/postcode-update', function (req, res) {
  ...
  res.redirect('/v24/apply/address-2-update');
 ...
 router.post('/v24/postcode-update-2', function (req, res) {
  ...
  res.redirect('/v24/apply/address-2-update-without-cv');
 ...
 router.post('/v24/address-2-update', function (req, res) {
  ...
  res.redirect('/v24/apply/personal-details-answers-update');
...
router.post('/v24/get-your-security-code', function (req, res) {

  var getyoursecuritycode = req.session.data['getyoursecuritycode']

  if (getyoursecuritycode === "email") {
    res.redirect('/v24/apply/security-code-email')
  }
  else if (getyoursecuritycode === "textmessage") {
    res.redirect('/v24/apply/security-code-text-message') 
  }   
...
router.post('/v24/get-your-security-code-2', function (req, res) {

  var getyoursecuritycode = req.session.data['getyoursecuritycode']

  if (getyoursecuritycode === "email") {
    res.redirect('/v24/apply/security-code-email-2')
  }
  else if (getyoursecuritycode === "textmessage") {
    res.redirect('/v24/apply/security-code-text-message-2') 
  }   
...
// Enter your security code (ROUTE: ADD A NEW PREGNANCY)
    ...
    router.post('/v24/security-code-email', function (req, res) {

      res.redirect('/v24/apply/are-you-pregnant-update');
    
    })
  
    router.post('/v24/security-code-text-message', function (req, res) {
...
router.post('/v24/security-code-email-2', function (req, res) {

  res.redirect('/v24/apply/childs-first-name-update');

})

router.post('/v24/security-code-text-message-2', function (req, res) {
...
// (update) What is child's name? > Childs first name (ROUTE: ADD A NEW BABY OR CHILD)
  ...
  router.post('/v24/childs-first-name-update', function (req, res) {
    ...
    if (childsfirstname && childslastname) {
      res.redirect('/v24/apply/childs-date-of-birth-update')
    }
    else {
      res.redirect('/v24/childs-first-name-update')
    }
  ...
  router.post('/v24/childs-date-of-birth-update', function (req, res) {
    ...
    if (childsdateofbirthday && childsdateofbirthmonth && childsdateofbirthyear) {
      ...
      if (moment(childsdateofbirth).isBefore(today)) {
          ...
          if (moment(childsdateofbirth).isAfter(fouryearsfromtoday)) {
            ...
            res.redirect('/v24/apply/children-under-four-answers-update'); 
  ...
  // (update) children under 4 years old > answers (ROUTE: ADD A NEW BABY OR CHILD)
    ...
    router.post('/v24/children-under-four-answers-update', function (req, res) {
  ...
  router.post('/v24/are-you-pregnant-update', function (req, res) {

    var pregnant = req.session.data['pregnant']
  
    if (pregnant === "yes") {
      res.redirect('/v24/apply/due-date-update')
    }
    else if (pregnant === "no") {
      res.redirect('/v24/apply/kickouts/not-pregnant')
    }
  ...
  router.post('/v24/due-date-update', function (req, res) {
    ...
    if (duedateday && duedatemonth && duedateyear) {
      ...
      if (duedate < today) {
        ...
        res.redirect('/v24/apply/due-date-answers-update')
      }
  ...
  router.post('/v24/children-under-four-answers-update', function (req, res) {
    ...
    if (addanother === "yes") {
      ...
      res.redirect('/v24/apply/another-change')
    }
  ...
  router.post('/v24/another-change', function (req, res) {
  ...
  router.post('/v24/benefits', function (req, res) {
    ...
    let fullName = req.session.fullName
      ...
      if (Array.isArray(benefits)) {
        ...
        if (benefits.includes('UC')) {
          ...
          res.redirect('/v24/apply/jobseekers-allowance')
          ...
          if (benefits.includes('UC')) {
            ...
            if (fullName == "SARAH GREEN") {
              res.redirect('/v24/apply/child-tax-credits')
            } else {
              res.redirect('/v24/apply/child-tax-credits')
            }
            ...
            res.redirect('/v24/apply/employment-support-allowance')
          } else if (benefits.includes('IS')) {
            res.redirect('/v24/apply/are-you-pregnant')
          } else if (benefits.includes('PC')) {
            res.redirect('/v24/apply/pension-credit')
...
router.post('/v24/universal-credit', function (req, res) {
  ...
  if (universalcredit === "yes") {
    ...
    res.redirect('/v24/apply/kickouts/not-eligible')
  }
  else {
    res.redirect('/v24/apply/universal-credit')
  }
...
router.post('/v24/child-tax-credits', function (req, res) {

  var childtaxcredits = req.session.data['childtaxcredits']

  if (childtaxcredits === "yes") {
    res.redirect('/v24/apply/working-tax-credit')
  }
...
router.post('/v24/working-tax-credit', function (req, res) {
...
router.get('/v24/jobseekers-allowance', (req, res) => {
...
router.get('/v24/employment-support-allowance', (req, res) => {
...
router.get('/v24/working-tax-credits', (req, res) => {
...
router.post('/v24/pension-credit', function (req, res) {
  ...
  router.post('/v24/nationality', function (req, res) {
    ...
    if (nationality) {
      ...
      res.redirect('/v24/apply/nationality')
    }
  ...
  router.post('/v24/are-you-pregnant', function (req, res) {
  ...
  router.post('/v24/due-date', function (req, res) {
  ...
  router.post('/v24/childs-first-name', function (req, res) {
  
    var childsfirstname = req.session.data['childsfirstname']
    var childslastname = req.session.data['childslastname']

    if (childsfirstname && childslastname) {
      res.redirect('/v24/apply/childs-date-of-birth')
    }
    else {
      res.redirect('/v24/apply/childs-first-name')
    }
    ...
    router.post('/v24/childs-date-of-birth', function (req, res) {
    ...
    router.post('/v24/children-under-four-answers', function (req, res) {
  ...
  router.post('/v24/email-address', function (req, res) {
  ...
  router.post('/v24/mobile-phone-number', function (req, res) {
  ...
  router.post('/v24/contact-preferences', function (req, res) {
    ...
    if (contact) {
      ...
      if (emailAddress || mobile || contact === 'NONE'){
        res.redirect('/v24/apply/bank-details')    
      }
      else {
        res.redirect('/v24/apply/contact-preferences')
      }
  ...
  router.post('/v24/bank-details', function (req, res) {
  ...
  router.post('/v24/feedback', function (req, res) {
    res.redirect('/v24/feedback')
  })


// v24 Check Your Answers

// N.B ALL PERSONALISATION VARIABLES NEED TO BE THERE, IF THEY'RE NOT REQUIRED YOU STILL NEED TO SEND AN EMPTY STRING ""

router.post('/v24/check-your-answers', function (req, res) {
  ...
  if (lastname == 'Green' || lastname == 'Elba') {
    res.redirect('/v24/apply/confirmation-pending-evidence')
    ...
    if (emailAddress) {
      ...
      if (pregnant === "yes") {
            res.redirect('/v24/apply/confirmation-successful');
      } else {
        res.redirect('/v24/apply/confirmation-successful');
      }
...
router.post('/v24/return-reference-number', function (req, res) {

  var referencenumber = req.session.data['referencenumber']
  req.session.data['savedUntil'] = moment().add(3, 'months').format("D MMMM YYYY")

  if (referencenumber) {
    res.redirect('/v24/apply/return-date-of-birth')
  }
  else {
    res.redirect('/v24/apply/return-reference-number')
  }
...
router.post('/v24/return-date-of-birth', function (req, res) {
  ...
  if (returnday && returnmonth && returnyear) {
    res.redirect('/v24/apply/return-task-list')
  }
  else {
    res.redirect('/v24/apply/return-date-of-birth')
  }
...
router.post('/v24/return-applicant-identity-select', function (req, res) {

  var applicantidentity = req.session.data['applicantidentity']

  if (applicantidentity) {
    res.redirect('/v24/apply/return-applicant-identity')
  }
  else {
    res.redirect('/v24/apply/return-applicant-identity')
  }
...
router.post('/v24/return-applicant-identity-upload', function (req, res) {
  ...
  if (anotherFile === 'yes') {
    ...
    res.redirect('/v24/apply/return-applicant-identity-upload')
  }
...
router.post('/v24/return-applicant-eligibility-upload', function (req, res) {

  const anotherFile = req.session.data['add-file2']

  if (anotherFile === 'yes') {
    res.redirect('/v24/apply/return-applicant-eligibility')
  } else if (anotherFile === 'no') {
    req.session.data["applicant-eligibility"] = "Complete";
    res.redirect('/v24/apply/return-task-list')
  } else {
    res.redirect('/v24/apply/return-applicant-eligibility-upload')
  }
...
router.post('/v24/return-child-eligibility-upload', function (req, res) {

  const anotherFile = req.session.data['add-file3']

  if (anotherFile === 'yes') {
    res.redirect('/v24/apply/return-child-eligibility')
  } else if (anotherFile === 'no') {
    req.session.data["child-eligibility"] = "Complete";
    res.redirect('/v24/apply/return-task-list')
  } else {
    res.redirect('/v24/apply/return-child-eligibility-upload')
  }
...
router.post('/v24/online-account', function (req, res) {
  ...
  if (onlineAccount) {
    ...
    res.redirect('/v24/apply/online-account')
  }
...
router.post('/v24/email-address-2', function (req, res) {
