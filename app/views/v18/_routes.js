...
router.post('/v18/where-do-you-live', function (req, res) {

  const whereDoYouLive = req.session.data['where-do-you-live']

  if (whereDoYouLive == 'yes') {
    res.redirect('/v18/apply/date-of-birth');
  } else {
    res.redirect('/v18/apply/kickouts/not-eligible-country');
  }
...
router.post('/v18/date-of-birth', function (req, res) {
  ...
  if (dateofbirthday && dateofbirthmonth && dateofbirthyear) {
    if (yrs < 16) {
      res.redirect('/v18/apply/kickouts/under-sixteen-signpost')
    } else {
      res.redirect('/v18/apply/name');
    }
  } else {
    res.redirect('/v18/apply/date-of-birth')
  }
...
router.post('/v18/name', function (req, res) {
  ...
  if (firstname && lastname) {
    res.redirect('/v18/apply/address')
  }
  else {
    res.redirect('/v18/apply/name')
  }
  ...
  router.post('/v18/address', function (req, res) {
    ...
    if (addressline1 && towncity && postcode) {
      res.redirect('/v18/apply/national-insurance-number')
    } else {
      res.redirect('/v18/apply/address')
    }
  ...
  router.post('/v18/national-insurance-number', function (req, res) {

    var nationalinsurancenumber = req.session.data['nationalinsurancenumber'].toUpperCase().replace(/\s+/g, '');
  
    if (nationalinsurancenumber) {
      res.redirect('/v18/apply/check-your-answers-personal-details')
    } else {
      res.redirect('/v18/apply/national-insurance-number')
    }
  ...
  router.post('/v18/cya-personal-details', (req, res) => {
...
router.post('/v18/benefits', function (req, res) {
  ...
  let fullName = req.session.fullName
    ...
    if (Array.isArray(benefits)) {
      ...
      if (benefits.includes('UC')) {
        ...
        res.redirect('/v18/apply/jobseekers-allowance')
        ...
        if (benefits.includes('UC')) {
          ...
          if (applicantsAge >= 16 && applicantsAge <= 18) {
            res.redirect('/v18/apply/kickouts/under-eighteen-signpost')
          } else {
...
router.get('/v18/employment-support-allowance', (req, res) => {
...
router.get('/v18/working-tax-credits', (req, res) => {
...
router.post('/v18/pension-credit', function (req, res) {
  ...
  router.post('/v18/nationality', function (req, res) {
    ...
    if (nationality) {
      ...
      res.redirect('/v18/apply/nationality')
    }
  ...
  router.post('/v18/are-you-pregnant', function (req, res) {
    ...
    if (pregnant === "yes") {
      ...
      req.session.data.lessThanTenWeeksPregnant = true;
      res.redirect('/v18/apply/children-under-four')
    }
    else {
      res.redirect('/v18/apply/are-you-pregnant')
    }
  ...
  router.post('/v18/due-date', function (req, res) {
  ...
  router.post('/v18/children-under-four', function (req, res) {
  ...
  router.post('/v18/childs-first-name', function (req, res) {
    ...
    if (childsfirstname && childslastname) {
      res.redirect('/v18/apply/childs-date-of-birth')
    }
    else {
      res.redirect('/v18/apply/childs-first-name')
    }
    ...
    router.post('/v18/childs-date-of-birth', function (req, res) {
      ...
      if (childsdateofbirthday && childsdateofbirthmonth && childsdateofbirthyear) {
        ...
        if (moment(childsdateofbirth).isBefore(today)) {
            ...
            if (moment(childsdateofbirth).isAfter(fouryearsfromtoday)) {
              ...
              res.redirect('/v18/apply/children-under-four-answers');          
    ...
    router.post('/v18/children-under-four-answers', function (req, res) {
      ...
      if (childrenunderfouranswers === "yes") {
        ...
        res.redirect('/v18/apply/kickouts/no-eligible-children')
      }
  ...
  router.post('/v18/email-address', function (req, res) {
  
    var emailaddress = req.session.data['emailaddress']
  
    res.redirect('/v18/apply/mobile-phone-number')
  
  })
  
  // What is your mobile phone number?
  
  router.post('/v18/mobile-phone-number', function (req, res) {
  
    var mobilePhoneNumber = req.session.data['mobilephonenumber']
  
    res.redirect('/v18/apply/check-your-answers')
  
  })
  
  // Contact Preferences
  
  router.post('/v18/contact-preferences', function (req, res) {
    ...
    if (contact) {
      ...
      if (emailAddress || mobile || contact === 'NONE'){
        res.redirect('/v18/apply/bank-details')    
      }
      else {
        res.redirect('/v18/apply/contact-preferences')
      }
  ...
  router.post('/v18/bank-details', function (req, res) {
  ...
  router.post('/v18/feedback', function (req, res) {
    res.redirect('/v18/feedback')
  })


// v18 Check Your Answers
...
router.post('/v18/check-your-answers', function (req, res) {
  ...
  if (lastname == 'Green') {
    res.redirect('/v18/apply/confirmation-pending-evidence')
    ...
    if (emailAddress) {
      ...
      if (pregnant === "yes") {
            res.redirect('/v18/apply/confirmation-successful');
      } else {
        res.redirect('/v18/apply/confirmation-successful');
      }
...
router.post('/v18/return-reference-number', function (req, res) {

  var referencenumber = req.session.data['referencenumber']

  if (referencenumber) {
    res.redirect('/v18/apply/return-date-of-birth')
  }
  else {
    res.redirect('/v18/apply/return-reference-number')
  }
...
router.post('/v18/return-date-of-birth', function (req, res) {
  ...
  if (returnday && returnmonth && returnyear) {
    res.redirect('/v18/apply/return-task-list')
  }
  else {
    res.redirect('/v18/apply/return-date-of-birth')
  }
...
router.post('/v18/return-applicant-identity-upload', function (req, res) {
...
router.post('/v18/return-applicant-eligibility-upload', function (req, res) {
...
router.post('/v18/return-child-eligibility-upload', function (req, res) {
